...
The approach was implemented through Keras API \cite{keras} using TensorFlow \cite{tensorflow} as backend. For more details, please refer to the GitHub repository\footnote{\github}.
