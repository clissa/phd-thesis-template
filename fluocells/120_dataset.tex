...
% \centering
% \subfloat[]{
% \includegraphics[width=\textwidth]{figures/120_dataset/annotated_i_clumping.png}
% \label{fig:artifacts:clumping}
% }

% % \centering
% % \subfloat[]{
% % \includegraphics[width=0.65\textwidth]{figures/120_dataset/annotated_i_stripe.png}
% % \label{fig:artifacts:stripe}
% % }
% % \centering
% % \subfloat[]{
% % \includegraphics[width=0.65\textwidth]{figures/120_dataset/annotated_i_macaroon.png}
% % \label{fig:artifacts:macaroon}
% % }
% \vspace{-0.2cm}
% \caption{
