...
\citeA{clusterlog2021} accounts for all these stages and could be adapted for FTS errors as is, it also presents some relevant drawbacks.
...
\input{opint/411_preprocessing}
\input{opint/412_vectorization}
\input{opint/413_clustering}
\input{opint/414_description}