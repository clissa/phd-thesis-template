...
\sidenote[Luca][notesyellow]{Aggiungere dettagli runtime prima nei result/method}
...
\sidenote[Luca][notesyellow]{Aggiungere focus su embedding più che clustering dal momento la difficoltà del raggruppamento è dovuta principalmente all'embedding}
