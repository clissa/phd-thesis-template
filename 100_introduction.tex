...
% The trend of Google searches for the term ``data science" (\hyperref[fig:GoogleTrendsDS:ts]{a}) and the corresponding geolocalization (\hyperref[fig:GoogleTrendsDS:map]{b}) show an evident increase of the popularity of the subject and its global penetration. The scale index in (\hyperref[fig:GoogleTrendsDS:map]{b}) is a re-scaled measure of the number of searches, where 100 corresponds to the maximum number of searches and 0 means that insufficient data were available.
